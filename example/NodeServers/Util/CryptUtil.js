...
module.exports.encrypt = (_source) =>
{
    var source = Buffer.from(_source, 'utf8');
    var dest = Buffer.alloc(source.length);
...
module.exports.decrypt = (_data) =>
{
    var data = Buffer.from(_data, "base64");
    var source = Buffer.alloc(data.length);
    for (var i = 0; i < source.length; i++)
    {
        source[i] = decryptData[data[i]];
    }
