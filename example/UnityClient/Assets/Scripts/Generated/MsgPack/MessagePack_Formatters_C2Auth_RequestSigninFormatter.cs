...
{
    public sealed class RequestSigninFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::C2Auth.RequestSignin>
    {

        public void Serialize(ref global::MessagePack.MessagePackWriter writer, global::C2Auth.RequestSignin value, global::MessagePack.MessagePackSerializerOptions options)
        {
            if (value == null)
            {
                writer.WriteNil();
        ...
        public global::C2Auth.RequestSignin Deserialize(ref global::MessagePack.MessagePackReader reader, global::MessagePack.MessagePackSerializerOptions options)
        {
            ...
            var ____result = new global::C2Auth.RequestSignin();
