...
public class SoundPlay : MonoBehaviour
{
    ...
    public void Init(int _soundSEQ, SOUND_CHANNEL _channel, int _ownerID, AudioClip _clip, float _volumn, bool _loop, float _waitTime, float _fadeInTime)
    {
        mSoundSEQ = _soundSEQ;
        mChannel = _channel;
        mGroupID = _ownerID;
